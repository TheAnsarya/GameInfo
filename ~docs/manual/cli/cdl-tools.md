...
**FCEUX:**
1. Debug → Code/Data Logger → Start
2. Play game
3. Debug → Code/Data Logger → Save

**Mesen:**
1. Debug → Code/Data Logger → Start
2. Play game
3. File → Save CDL file

**bsnes:**
1. Tools → Tracer → Enable CDL
2. Play game
3. Save CDL file
...
**Purpose:** Verify FCEUX → Mesen conversion.
...
**Purpose:** Verify Mesen → FCEUX conversion.
...
**Purpose:** Verify bsnes → FCEUX conversion.
...
- Flag mapping applied correctly (0x80→Code, 0x40→Data)
...
|---------|-------------|--------|------|--------|
| TEST-CDL-001 | FCEUX stats | ☐ | | |
| TEST-CDL-002 | Mesen stats | ☐ | | |
| TEST-CDL-003 | Format option | ☐ | | |
| TEST-CDL-004 | Bank breakdown | ☐ | | |
| TEST-CDL-005 | Custom bank size | ☐ | | |
| TEST-CDL-006 | Default heatmap | ☐ | | |
| TEST-CDL-007 | Custom width | ☐ | | |
| TEST-CDL-008 | CSV export | ☐ | | |
| TEST-CDL-009 | Show regions | ☐ | | |
| TEST-CDL-010 | Min size filter | ☐ | | |
| TEST-CDL-011 | Merge two | ☐ | | |
| TEST-CDL-012 | Merge multiple | ☐ | | |
| TEST-CDL-013 | Diff files | ☐ | | |
| TEST-CDL-014 | Export MLB | ☐ | | |
| TEST-CDL-015 | Export SYM | ☐ | | |
| TEST-CDL-016 | FCEUX→Mesen | ☐ | | |
| TEST-CDL-017 | Mesen→FCEUX | ☐ | | |
| TEST-CDL-018 | bsnes→FCEUX | ☐ | | |
