...
### JavaScript SDK
```javascript
import { DarkReposEditor } from '@darkrepos/editor-sdk';

const editor = new DarkReposEditor('http://localhost:5280');
...
### Python SDK
```python
from darkrepos_editor import DarkReposEditor

editor = DarkReposEditor('http://localhost:5280')
