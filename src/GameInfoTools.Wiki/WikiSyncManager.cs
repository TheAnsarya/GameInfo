...
/// <summary>
/// Manages synchronization state between local wiki documents and Data Crystal.
/// Tracks which files have been reviewed for upload and their sync status.
///
/// ⚠️ IMPORTANT: All content generated by AI tools MUST be manually reviewed
/// and edited before uploading to Data Crystal. The wiki strictly forbids
/// AI-generated content, and violations will result in a ban.
/// </summary>
public class WikiSyncManager {
	...
	///
	/// ⚠️ IMPORTANT: Only mark as reviewed after a human has manually
	/// verified and edited the content. AI-generated content is forbidden
	/// on Data Crystal and will result in a ban.
	/// </summary>
